...
if(isset($_POST["export_data"])){
	...
	$sql = "SELECT userID,farmId, datetime,$sensor FROM data_values WHERE userID = '$userid' and datetime between '$startDate' and '$endDate 23:59:59'"; 
	...
	array_unshift($sensorNames,"UserID","farmId","DateTime");
